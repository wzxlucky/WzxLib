...
/**
 * 描述：本地SharedPreferences存储数据工具类
 * 名称: SharedPreferencesUtil
 * 版本: 1.0
 * 日期: 2018/4/16 14:44
 *
 * @author wsy
...
public class SharedPreferencesUtil {
     ...
     * 保存在手机里面的文件名
     */
    private static final String FILE_NAME = "tsq_sp";
    ...
    public static void putImage(Context mContext, String key, ImageView imageView) {
        ...
        // 将String保存shareUtils
        SharedPreferencesUtil.put(mContext, key, imgString);
    }
    ...
    public static Bitmap getImage(Context mContext, String key, ImageView imageView) {
        String imgString = (String) SharedPreferencesUtil.get(mContext, key, "");
        if (!imgString.equals("")) {
            // 利用Base64将我们string转换
